...
define( 'UPDATE_DOCTOR_VERSION', '1.2.11' );
...
require_once UPDATE_DOCTOR_DIR . 'includes/class-host-detector.php';
...
require_once UPDATE_DOCTOR_DIR . 'includes/class-activity-recorder.php';
...
require_once UPDATE_DOCTOR_DIR . 'includes/checks/class-opcache-check.php';
require_once UPDATE_DOCTOR_DIR . 'includes/checks/class-unattended-gate-check.php';
...
require_once UPDATE_DOCTOR_DIR . 'includes/checks/class-activity-check.php';
